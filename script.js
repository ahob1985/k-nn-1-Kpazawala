...
function buildButtons() {
  ...
  upButton = createButton("Up");upButton.parent(buttonDiv);
  ...
  downButton = createButton("Down");downButton.parent(buttonDiv);
  ...
  leftButton = createButton("Left");leftButton.parent(buttonDiv);
  ...
  rightButton = createButton("Right");rightButton.parent(buttonDiv);
